---
title: 'What is SummitShare?'
description: 'A vehicle for collaboration in digital repatriation and preservation of African culture'
tags: [Narrative, Documentation]
...
This distinction is derived from the precedence of the development of the platform as well as expectations for it (looking at the past and looking at the future. A retrospective and a modern perspective).
...
The repatriation of cultural artifacts, especially those from Africa, has gained significant momentum in recent years, yet remains a complex and slow-moving process. The situation concerning famous collections such as the [**Benin Bronzes**](https://www.britishmuseum.org/about-us/british-museum-story/contested-objects-collection/benin-bronzes) and the [**Rosetta Stone**](https://www.britishmuseum.org/blog/everything-you-ever-wanted-know-about-rosetta-stone) illustrates both progress and ongoing challenges in the restitution landscape.
A good example of the current State of Repatriation Efforts would be;
...
If you wish to learn more about our smart contracts and code please [[see here]](https://github.com/SummitShare/SummitShare-Source/tree/Central/packages/contracts)

The platform aims to create a relationship between 21st-century individuals and artifacts from the 16th century and beyond, adding value to individuals, societies, and organizations focused on cultural preservation, its studies and encouraging research into the subject matter.
...
## **How is the success of the project defined?**
...
In totality, it’s the body or the people behind the ideology who will cause the solution to come into fruition. The project comes before the platform.
...
## **Outline of General Strategic Goals**

1. **1. Engagement with Governments and Institutions:** Building partnerships and dialogues to support the project’s infrastructure and legitimacy.

2. **2. Publication and Education:** Disseminating research and whitepapers to establish SummitShare as an authority on cultural preservation and repatriation.

3. **3. Community Building:** Cultivating an open-source community to contribute to and expand upon SummitShare’s platform, ensuring it remains a living, evolving project.

4. **4. Technological Advancements:** Continuously updating the platform to enhance its functionality and accessibility, making the rich tapestry of African history available to a global audience.
