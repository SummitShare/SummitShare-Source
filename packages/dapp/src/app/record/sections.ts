export type RecordSection = {
   ...
   /** Portrait crop of `graphics`, generated by scripts/generate-record-crops.mjs. */
   readonly portraitGraphics: string;
...
export const SECTIONS = [
   {
      ...
      portraitGraphics: 'graphics-1-portrait.svg',
      icons: 'icons-1.svg',
   ...
   },
   {
      ...
      portraitGraphics: 'graphics-2-portrait.svg',
      icons: 'icons-2.svg',
      name: 'MBUSA',
   ...
   },
   {
      ...
      portraitGraphics: 'graphics-3-portrait.svg',
      icons: 'icons-3.svg',
      name: 'NGOMA PWITA',
