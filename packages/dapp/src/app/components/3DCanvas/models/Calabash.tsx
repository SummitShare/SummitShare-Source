...
export function Calabash(props: JSX.IntrinsicElements['group']) {
  ...
  return (
    <group {...props} dispose={null}>
      <mesh geometry={nodes.calabash_base.geometry} material={materials.POT} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.calabash_nest.geometry} material={materials.wire_224198087} rotation={[Math.PI / 2, 0, 0]} />
    </group>
  )
}
