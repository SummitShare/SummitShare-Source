 ...
 */
const Buttons: React.FC<ButtonProps> = ({ children, type = 'primary', size = 'small', active = true, ...props }) => {
  ...
  const className = `${baseClass} ${type === 'primary' && primaryClass}  ${type === 'tartary' && tartaryClass}  ${type === 'secondary' && secondaryClass}  ${type === 'subTartary' && subTartaryClass}  ${sizeClass} ${sizeClass}`;
