...
function Hero() {
// Custom hook to fetch recent exhibits data
          ...
          >
            ...
            <div className="bg-gray-50/25 backdrop-blur-md rounded-xl w-[100%] h-fit p-6 space-y-6 md:w-[30%] md:absolute md:right-10 md:top-[30%]">
              <div className="space-y-2 min-h-20">
                ...
                <p className="text-sm text-gray-50/80">Vist the first ever virtual exibit hosted on the web3 space and contrbute to cultrul repatriation</p>
              </div>
