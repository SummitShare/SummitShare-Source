...
const steps = [ 
  {  
    ...
    description: (
      <>
        ...
        <div className="mt-2">SummitShare uses on-chain transactions with stablecoins for speed, transparency, and price stability.</div>
      </>
    )
  },
  {  
  ...
  {  
    ...
    description: (
      <>
        <div>After connecting your wallet, proceed to <strong>purchase a ticket</strong> by selecting the event you want to attend.{' '}
        ...
        <a href="https://support.metamask.io/hc/en-us/articles/360015489871-What-are-gas-fees-" target="_blank" rel="noopener noreferrer" className="text-orange-600 hover:underline">learn more about gas fees</a>.</div>
      </>
    )
  }, 
  {  
...
<Card 
  className={`w-full sm:w-64 m-2 cursor-pointer transition-all duration-300 hover:shadow-lg ${isActive ? 'ring-2 ring-orange-700' : ''}`}
  onClick={onClick}
>
