...
const women = [
  ...
  return (<div className="space-y-24 mx-6 my-28">
   ...
   {open&&<div className="fixed inset-x-0 top-0 bottom-0 bg-primary-900/50 flex items-center justify-center z-10">
      <div className="space-y-6 p-6 rounded-[0.8rem] border border-primary-100 bg-white w-[90%] lg:w-[30%]">
        <div className="w-full">
          <XMarkIcon onClick={()=>setOpen(!open)} className="float-end w-6" />
        </div>
