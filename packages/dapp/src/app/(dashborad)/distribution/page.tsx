  ...
  return (
    <div className="min-h-screen flex flex-col justify-between mx-6 mt-6 mb-[48px]">
      <nav className="w-full flex flex-row justify-between items-center">
        <p className="text-p2-m">Distrbution</p>
        <p>Exit</p>
      </nav>
      ...
      <div className="flex flex-row justify-between w-full">
        <p className="text-2xl font-medium ">Beneficiaries</p>
        <div className=" flex items-center justify-center w-[30px] h-[30px] p-2 bg-ge-100 text-p2-m text-ge-500 rounded-full">
          3
        </div>
      </div>
      <Inputs
      ...
      <div className="space-y-4 pb-[48px] border-b border-primary-50">
        <Inputs
          ...
          label="username"
          state="inactive"
          defaultValue="Latoya Nienow"
        />
        <Inputs
          type="input"
          label="Wallet address"
          state="inactive"
          defaultValue="0x94b008aA00579c1307B0E"
        />
        <Inputs
          type="input"
          label="Share"
      ...
      <div className="sapce-y-4 text-p2-r">
        <div className="flex felx-row justify-between ">
          <p>Tickets sold</p>{' '}
          <p className="text-p2-m font-semibold">
            100<span className="font-normal"> of 300</span>
          </p>
        </div>
        <div className="flex felx-row justify-between ">
          <p>Distribution Amount</p>{' '}
          <p className="text-p2-m font-semibold text-ge-500">ETH 20</p>
        </div>
      </div>
