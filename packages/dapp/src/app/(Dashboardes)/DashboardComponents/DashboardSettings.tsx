    ...
    <div className="px-6 space-y-20 lg:mx-[250px]">
      ...
      <section className="space-y-5">
        <div className="flex flex-row gap-4 items-center">
          ...
          <div>
            <p className="text-base font-bold text-violet-500">Change Image</p>
        ...
        <div className="space-y-4">
          ...
          <div className="gap-2 flex flex-col">
            ...
            <input
              className="w-[338px] h-[56px] lg:w-[510px] pl-5 rounded-full border caret-violet-500 placeholder:text-sm"
              type="text"
          ...
          {/* Save Button */}
          <button className="bg-violet-500 rounded-full py-4 px-3 text-base text-white w-[112px] ">
            Save
          </button>
        </div>
      </section>
      ...
      <section className="space-y-5">
        ...
        <div className="space-y-4">
          ...
          {/* Save Button */}
          <button className="bg-violet-500 rounded-full py-4 px-3 text-white w-[112px] ">
            Save
          </button>
        </div>
      </section>
      ...
      <section className="space-y-5">
        ...
        <button className="bg-violet-500 rounded-full py-4 px-3 text-white w-[232px] ">
