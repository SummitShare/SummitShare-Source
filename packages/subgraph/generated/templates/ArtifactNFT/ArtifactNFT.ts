...
export class ArtifactNFT extends ethereum.SmartContract {
  static bind(address: Address): ArtifactNFT {
    return new ArtifactNFT("ArtifactNFT", address);
  }
  ...
  mint(to: Address, quantity: BigInt): BigInt {
  ...
  try_mint(to: Address, quantity: BigInt): ethereum.CallResult<BigInt> {
