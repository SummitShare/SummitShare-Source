...
export declare class ContractVerificationRequestError extends HardhatVerifyError {
...
export declare class ContractStatusPollingError extends HardhatVerifyError {
    constructor(url: string, parent: Error);
}
