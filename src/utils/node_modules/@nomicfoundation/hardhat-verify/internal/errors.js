...
class HardhatNetworkNotSupportedError extends HardhatVerifyError {
    constructor() {
        super(`The selected network is "hardhat", which is not supported for contract verification. Please choose a network supported by Etherscan.
...
class ContractVerificationRequestError extends HardhatVerifyError {
...
exports.ContractVerificationRequestError = ContractVerificationRequestError;
...
class ContractStatusPollingError extends HardhatVerifyError {
    constructor(url, parent) {
        super(`Failure during etherscan status polling. The verification may still succeed but
should be checked manually.
Endpoint URL: ${url}
Reason: ${parent.message}`, parent);
    }
}
exports.ContractStatusPollingError = ContractStatusPollingError;
