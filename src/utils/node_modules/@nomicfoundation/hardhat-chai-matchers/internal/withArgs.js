...
function supportWithArgs(Assertion, chaiUtils) {
    Assertion.addMethod("withArgs", function (...expectedArgs) {
        ...
        const onSuccess = () => {
            if (emitCalled) {
                return (0, emit_1.emitWithArgs)(this, Assertion, chaiUtils, expectedArgs, onSuccess);
            }
            else {
                return (0, revertedWithCustomError_1.revertedWithCustomErrorWithArgs)(this, Assertion, chaiUtils, expectedArgs, onSuccess);
            }
        };
