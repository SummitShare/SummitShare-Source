...
export declare function revertedWithCustomErrorWithArgs(context: any, Assertion: Chai.AssertionStatic, _utils: Chai.ChaiUtils, expectedArgs: any[], ssfi: Ssfi): Promise<void>;
